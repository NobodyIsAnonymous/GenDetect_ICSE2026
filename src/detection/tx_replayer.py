...
class Replayer:
    ...
    def __init__(self, network='mainnet'):
        ...
        # [修改] 使用 os.path.join 拼接 DATA_DIR
        self.no_loop_rule_file = os.path.join(DATA_DIR, 'noloop_encoded_trace.csv')
        
        # [修改] 读取 final_classified_functions.csv
        clusters_path = os.path.join(DATA_DIR, 'final_classified_functions.csv')
        self.clusters, self.remaining_non_cluster, self.unique_non_cluster, self.model, self.centroids = read_data(clusters_path)
